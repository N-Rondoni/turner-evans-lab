...
if __name__=="__main__":
    ...
    # try more coarse imaging rates, then continuously mapping soln to smaller expected timeVec
    if dset == 1:
        imRate = 1/59.1
        kf = 0.0513514
        kr = 7.6 
...
#    print(model.u.keys())
    ...
    params_simulator = {
            ...
            'abstol': 1e-10,
            'reltol': 1e-10,
            't_step': imRate, # (s) mean step is 6.11368547250401 in data
            }
...
#    Ci_f = mpc.data['_x'][:, 1]
    ...
    corrCoef = np.corrcoef(s[200:], spikeDat[200:])[0, 1] # toss first 200 time instants, contains bad transients.
