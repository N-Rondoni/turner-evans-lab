...
cors_Oasis = np.load("data/allScores_Oasis.npy")
cors1_Oasis = np.load("data/allScoresDset1_Oasis.npy")
cors2_Oasis = np.load("data/allScoresDset2_Oasis.npy")
cors3_Oasis = np.load("data/allScoresDset3_Oasis.npy")
cors4_Oasis = np.load("data/allScoresDset4_Oasis.npy")
cors5_Oasis = np.load("data/allScoresDset5_Oasis.npy")
cors6_Oasis =  np.load("data/allScoresDset6_Oasis.npy")
cors7_Oasis =  np.load("data/allScoresDset7_Oasis.npy")
cors8_Oasis =  np.load("data/allScoresDset8_Oasis.npy")
cors9_Oasis =  np.load("data/allScoresDset9_Oasis.npy")
allVPDs_Oasis = np.load("data/allVPDs_Oasis.npy")

print("all vpds", np.median(allVPDs_Oasis))
print("all means", np.mean(cors_Oasis))
