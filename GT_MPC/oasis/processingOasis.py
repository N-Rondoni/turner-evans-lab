...
#            spikeDat = np.array(spikeDat)
    ...
    #                node0_dset1.test.sVals.npy
                simSpikesRaw = np.load('data/resampled/solutions/node' + str(i) + '_dset' + str(dset) + '.' + str(stat) + '.sVals.Oasis.npy')
    ...
    np.save("data/allVPDs_Oasis", allVPDs)
    np.save("data/allScores_Oasis", downsampledCorScor)
    np.save("data/allScoresDset1_Oasis", downsampledCorScor1)
    np.save("data/allScoresDset2_Oasis", downsampledCorScor2)
    np.save("data/allScoresDset3_Oasis", downsampledCorScor3)
    np.save("data/allScoresDset4_Oasis", downsampledCorScor4)
    np.save("data/allScoresDset5_Oasis", downsampledCorScor5)
    np.save("data/allScoresDset6_Oasis", downsampledCorScor6)
    np.save("data/allScoresDset7_Oasis", downsampledCorScor7)
    np.save("data/allScoresDset8_Oasis", downsampledCorScor8)
    np.save("data/allScoresDset9_Oasis", downsampledCorScor9)
